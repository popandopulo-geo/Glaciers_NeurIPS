...
from DeepLearning.LSTMTrain_temperature.lstmAttention import LSTM as lstmAttentionTemp
...
model = lstmAttentionTemp(3,3, 2500, 2500, 0.1, 5,  device).to(device)
...
with torch.no_grad():
    ...
    for b in range(nIterations):
        ...
        for inpts, targets , temps in dataTest:
