...
temperature_model = LSTM_Temperature.LSTM_Temperature(lstmLayers=1, lstmHiddenSize=2500, lstmInputSize=2500, dropout=0.1, device=device).to(device)
...
functions.trainLoop(dataTrain, dataVal,  model,temperature_model, loss, False, "LSTMAttentionWithTemperature", params, False, device)
